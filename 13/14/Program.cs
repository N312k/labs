...
namespace Lab15
{
    class program
    {
        public static int Kdigit(string line)
        {
            int count = 0;
        ...
        public static int Kspace(string line)
        {
            int count = 0;
            for (int i = 0; i < line.Length; i++)
            {
        ...
        {
            string path1 = "D:/input.txt";
            string path2 = "D:/sorted.txt";
            ...
            while (line != null)
            {
                ...
                if (line != null)
                {
                    if (Kdigit(line) > Kdigit(deque.GetFirst())) deque.AddLast(line);
